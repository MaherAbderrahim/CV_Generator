...
export const PrimaryTemplate: React.FC<TemplateProps> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full flex flex-col md:flex-row justify-between items-center gap-4 border-b border-slate-100"
      ...
      >
        <div className="flex items-center gap-5">
          {personalInfo.photoUrl && (
            <img
              ...
              className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover border-2 shadow-sm"
        ...
        <div className="flex flex-col gap-1.5 text-xs text-slate-500 font-medium md:items-end">
          {personalInfo.email && (
      ...
      <div className="flex-grow flex flex-row" style={{ minHeight: 0 }}>
